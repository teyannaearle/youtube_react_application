    ...
    <div className="about-page">
      ...
      <div className="about Teyanna">
        <p>
          &emsp;
          <strong>
            A Queens native, Full Stack Web Developer, who studied at an
          ...
          are entitled to balance within their lives and the opportunity to live
          a life that makes them happy. As a family-oriented person, it is
          important for me to create tools that will help adults and children
          alike in a multitude of ways. Whether it is assisting young children
          educationally, with the development of their morality and behavior
          towards others, nurturing the enhancement of their imagination; or
          connecting older kids and adults with the resources/tools that can
          help them de-stress, get organized and/or help improve their overall
          sense of wellness. The aim is to help whomever I can, in this way,
          because I care about my wellness, your wellness and everyone else's
          wellness too!
        </p>
        <span className="collaborators"> 
          <p><strong>Teyanna Earle</strong>
